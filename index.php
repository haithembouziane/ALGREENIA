...
<body>
    ...
    <div class="page">
        ...
        <section id="projects" class="glass-theme">
            <h2 class="section-title">Afforestation Projects</h2>
            <p class="short-description">
            ...
            <div class="card-container">
                <div class="card">
                    <img class="card-img" src="path/to/project-image.jpg" alt="Project Image">
                    <h3 class="card-title">Project Name</h3>
                    <p class="card-description">
                        Date: <span>dd/mm/yyyy</span><br>
                        Location: <span>Location Name</span><br>
                        <br>Join us in this afforestation campaign to help restore green spaces.
                    </p>
                    <button class="btn-learn">Learn More</button>
                </div>
                <div class="card">
        ...
        <section id="resources" class="glass-theme">
            ...
            <div class="resource-container">
                <div class="resource-card">
                    <img class="resource-img" src="path/to/guide.jpg" alt="Planting Guide">
                    ...
                    <a href="#" class="btn-learn">Download Guide</a>
                </div>
                <div class="resource-card">
                    <img class="resource-img" src="path/to/video.jpg" alt="Educational Video">
                    ...
                    <a href="#" class="btn-learn">Watch Video</a>
                </div>
            </div>
        </section>
        ...
        <section id="stat" class="glass-theme">
            ...
            <div class="stat-container">
                ...
                <div class="stat-card">
                    ...
                    <h3 class="stat-title">Tonnes of CO2 to be captured approximately</h3>
                    <p class="stat-value" data-value="70">0</p>
                </div>
            </div>
        </section>

        <section class="sustainability-tips-section">
            ...
            <div class="resource-guides">
                ...
                <p>Download our guides for sustainable living:</p>
                <a href="#">Sustainable Gardening Checklist</a>
                <a href="#">Composting Basics PDF</a>
            </div>
        
            <div class="challenges">
                <h3>Monthly Challenges</h3>
                <p>Join our sustainability challenge this month: Reduce your water usage!</p>
                <a href="#">Share Your Progress</a>
            </div>
        
            <div class="community-contributions">
                <h3>Community Contributions</h3>
                <p>Share your sustainability tips with us!</p>
                <a href="#">Submit Your Tips</a>
            </div>
